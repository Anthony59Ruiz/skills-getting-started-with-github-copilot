...
activities = {
    ...
    "Drama Club": {
        "description": "Act in plays, improvise scenes, and build stagecraft skills",
    ...
    "Robotics Club": {
        "description": "Build robots, learn engineering, and prepare for competitions",
        "schedule": "Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "bella@mergington.edu"]
    }
}
